...
from sother.detectors.falcon.somo.solmoctor.core.cfg import EntryPoint, ExitPoint
...
TNewInstruction: TypeAlias = T.Union[NewArray, NewContract, NewStructure]
...
TEntryExitPoint: TypeAlias = T.Union[EntryPoint, ExitPoint]
