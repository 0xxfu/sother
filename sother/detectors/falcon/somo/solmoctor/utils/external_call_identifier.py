...
class ExternalCallIdentifier:
    def __init__(self) -> None:
        self._filter = lambda function: not (
            type(function) == SolidityFunction or function is None
        )
    ...
    def _obtain_call(
        ...
        call_item: T.Union[
            ...
            T.Tuple[Contract, FunctionContract],
        ],
    ...
    def identify(
        ...
        internal_calls: T.List[
            T.Union[FunctionContract, SolidityFunction, Modifier]
        ] = node.internal_calls

        # the potential current node calls to the functions outside the contract.
        # E.g., the function from the SafeMath library.
        library_calls: T.List[
            T.Union[
                FunctionContract, SolidityFunction, T.Tuple[Contract, FunctionContract]
            ]
        ] = node.library_calls
