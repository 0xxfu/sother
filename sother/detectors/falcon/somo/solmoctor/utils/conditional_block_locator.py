...
from slither.core.cfg.node import NodeType as FalconNodeType
from slither.core.declarations import SolidityFunction, Modifier, FunctionContract
...
class ConditionalBlockLocator:
    ...
    def is_conditional_node(
        self, node: FalconNode
    ) -> T.Union[bool, T.Tuple[Expression, CallExpression]]:
        """
    ...
    def extract_one_node(
        self, node: FalconNode
    ) -> T.Union[CallExpression, Expression, None]:
    ...
    def extract(
        self, inputs: T.Union[Modifier, FunctionContract]
    ) -> T.List[T.Union[Expression, CallExpression]]:
