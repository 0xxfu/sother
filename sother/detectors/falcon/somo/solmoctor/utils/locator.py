...
from slither.core.declarations import FunctionContract, Modifier, Contract
...
class Locator:
    ...
    def _locate(
        self,
        signature_str: str,
        targets: T.List[T.Union[StateVariable, FunctionContract, Modifier]],
    ...
    def locate(
        self, signature_str: str, t_type: TSlitherObj
    ) -> T.Union[StateVariable, FunctionContract, Modifier]:
        ...
        raise NoneTargetSlitherObject(
            f"Signature: {signature_str}, Type: {t_type} not obtained."
        )
