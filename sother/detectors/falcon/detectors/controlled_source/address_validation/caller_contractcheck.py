...
class CallerContractChecker(AbstractDetector):
    ...
    ARGUMENT = (
        "caller-check"  # falcon will launch the detector with falcon.py --mydetector
    )
        ...
        for contract in self.compilation_unit.contracts_derived:
            ...
            for fn in contract.functions_declared:
                ...
                for node in fn.all_nodes():
                    ...
                    codeSizingChecks = [
                        True for ir in node.irs if isinstance(ir, CodeSize)
                    ]
                    ...
                    for ir in node.irs:
                        ...
                        if isinstance(ir, Index):
                            if isinstance(ir.lvalue, ReferenceVariable) and (
                                SolidityVariableComposed("msg.sender")
                                in ir.lvalue.node.solidity_variables_read
                            ):
