...
from sother.detectors.falcon.somo.solmoctor.solmoctor import SolMoctor
...
class ModifierUnsafe(AbstractDetector):
    ...
    def _process_all(self):
        results = []
        self.somo = SolMoctor()
        self.falcon_copy_for_somo = copy.deepcopy(
            self.slither
        )  # Normal deep copy operation
