...
|ID|Issues|Instances|
|---|:---|:---:|
| [G-0] | Using `private` rather than `public` for constants, saves gas | 2 |
| [G-1] | `Bytes` constants are more efficient than `string` constants | 1 |
...
- `BytesConstants.bad` (solidity/test_string_constants.sol#L2) should be used `private` visibility to save gas.

- `BytesConstants.notBad` (solidity/test_string_constants.sol#L3) should be used `private` visibility to save gas.
...
### locations:
- solidity/test_string_constants.sol#L2
- solidity/test_string_constants.sol#L3
...
- `BytesConstants.bad` (solidity/test_string_constants.sol#L2) should use `bytes(1..31)` instead of `string`.
